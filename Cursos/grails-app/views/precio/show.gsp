...
<html>
    ...
    <body>
        ...
        <div id="show-precio" class="content scaffold-show" role="main">
            ...
            <f:display bean="precio" />
            <g:form resource="${this.precio}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.precio}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
