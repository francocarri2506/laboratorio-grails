...
<html>
    ...
    <body>
        ...
        <div id="edit-precio" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.precio}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.precio}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.precio}" method="PUT">
                <g:hiddenField name="version" value="${this.precio?.version}" />
                <fieldset class="form">
                    <f:all bean="precio"/>
                </fieldset>
