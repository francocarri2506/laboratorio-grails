  ...
  <div class="container">
    ...
    <div class="row mt">
      <div class="col-lg-4 col-md-4 col-xs-12 desc">
        <a class="b-link-fade b-animate-go" href="#"><asset:image width="350" src="cursoJava.jpg" alt="" />
					<div class="b-wrapper">
					  	<h4 class="b-from-left b-animate b-delay03">Curso Básico de Java</h4>
      ...
      <div class="col-lg-4 col-md-4 col-xs-12 desc">
        <a class="b-link-fade b-animate-go" href="#"><asset:image width="350" src="diseñoWeb.jpg" alt="" />
					<div class="b-wrapper">
					  	<h4 class="b-from-left b-animate b-delay03">Curso de Dieseño Web</h4>
					  	<p class="b-from-right b-animate b-delay03">Leer más</p>
					</div>
				</a>
      ...
      <div class="col-lg-4 col-md-4 col-xs-12 desc">
        <a class="b-link-fade b-animate-go" href="#"><<asset:image width="350" src="cursoRobotica.jpg" alt="" />
					<div class="b-wrapper">
					  	<h4 class="b-from-left b-animate b-delay03">Curso de Robótica</h4>
					  	<p class="b-from-right b-animate b-delay03">Leer más</p>
					</div>
				</a>
