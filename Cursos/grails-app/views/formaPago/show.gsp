...
<html>
    ...
    <body>
        ...
        <div id="show-formaPago" class="content scaffold-show" role="main">
            ...
            <f:display bean="formaPago" />
            <g:form resource="${this.formaPago}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.formaPago}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
