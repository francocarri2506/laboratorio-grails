...
<html>
    ...
    <body>
        ...
        <div id="show-docente" class="content scaffold-show" role="main">
            ...
            <f:display bean="docente" />
            <g:form resource="${this.docente}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.docente}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
