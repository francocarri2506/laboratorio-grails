...
class CertificadoAprobacionSpec extends Specification implements DomainUnitTest<CertificadoAprobacion> {
    ...
    def cleanup() {
       ...
       void "crear un certidicado de aprobacion del curso"() {
        when:"Se crea el objeto Curso "
            ...
            def certificado=new CertificadoAprobacion(curso:curso,expositor:expositor,autoridad:autoridad,interesado:interesado, descripcion:"certificadoaprobacion",nota:"9" )
            certificado.save(flush:true)
        then:"se agrega a la base de datos"  
            CertificadoAprobacion.findByNota("9")== certificado       
    }
}
